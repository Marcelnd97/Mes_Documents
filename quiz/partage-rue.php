...
<body class="codebody">
  ...
  <script>
    const quizData = [
      {
        question: "Un motard, peut circuler : - sur la voie A",
        image: "../images/quizrue/rue1.jpg",
        options: [
          {text:"A. OUI", isCorrect: false},
          {text:"B. NON", isCorrect: true}
          ],
        audioQuestion: "Un motard, peut circuler : - sur la voie A. A. OUI, B. NON",
        audioAnswer: "correct.mp3"
      },
      {
        question: "Un motard, peut circuler : - dans la zone B",
        image: "../images/quizrue/rue1.jpg",
        options: [
          {text:"C. OUI", isCorrect: true},
          {text:"D. NON", isCorrect: false}
          ],
        audioQuestion: "Un motard, peut circuler : - dans la zone B. C. OUI, D. NON",
        audioAnswer: "correct.mp3"
      },
      {
        question: "Je quitte :",
        image: "../images/quizrue/rue2.jpg",
        options: [
          {text:"A. une aire piéton", isCorrect: false},
          {text:"B. une zone de rencontre", isCorrect: true},
          ],
        audioQuestion: "Je quitte : A. une aire piéton, B. une zone de rencontre",
        audioAnswer: "correct.mp3"
      },
      {
        question: "Dans cette zone, les piétons : - peuvent utiliser toute la chaussée",
        image: "../images/quizrue/rue3.jpg",
        options: [
            {text:"A. OUI", isCorrect: true},
            {text:"B. NON", isCorrect: false},
        ],
        audioQuestion: "Dans cette zone, les piétons : - peuvent utiliser toute la chaussée A. OUI, B. NON",
        audioAnswer: "correct.mp3"
      },
      {
        question: "Dans cette zone, les piétons : - sont prioritaires sur tous les véhicules, sauf face aux tramways",
        image: "../images/quizrue/rue3.jpg",
        options: [
          {text: "C.OUI", isCorrect: true}, 
          {text: "D.NON", isCorrect: false},
        ],
        audioQuestion: "Dans cette zone, les piétons : - sont prioritaires sur tous les véhicules, sauf face aux tramways  C.OUI, D.NON",
        audioAnswer: "correct.mp3"
      },
      {
        question: "En empruntant cette voie, je peux croiser :",
        image: "../images/quizrue/rue4.jpg",
        options: [
          {text: "A. des cyclistes", isCorrect: true}, 
          {text: "B. des cyclomotoristes", isCorrect: false},
        ],
        audioQuestion: "En empruntant cette voie, je peux croiser : A. des cyclistes, B. des cyclomotoristes",
        audioAnswer: "correct.mp3"
      },
      {
        question: "Une aire piétonne est signalée par le panneau :",
        image: "../images/quizrue/rue5.jpg",
        options: [ 
          {text: "A. n°1", isCorrect: false}, 
          {text: "B. n°2", isCorrect: true}
        ],
        audioQuestion: "Une aire piétonne est signalée par le panneau : A. n°1, B. n°2",
        audioAnswer: "correct.mp3"
      },
      {
        question: "Je suis bien placé :",
        image: "../images/quizrue/rue6.jpg",
        options: [ 
          {text: "C. OUI", isCorrect: true},
          {text: "D. NON", isCorrect: false}
        ],
        audioQuestion: "Je suis bien placé :. C. OUI, D. NON",
        audioAnswer: "correct.mp3"
      },
      {
        question: "Il est 10h. Je peux circuler dans cette zone :",
        image: "../images/quizrue/rue7.jpg",
        options: [ 
          {text: "A. si je suis à pied ou si j'effectue une livraison", isCorrect: true},
          {text: "B. si j'ai un véhicule de plus de 12 t", isCorrect: false}
        ],
        audioQuestion: "Il est 10h. Je peux circuler dans cette zone. A. si je suis à pied ou si j'effectue une livraison, B. si j'ai un véhicule de plus de 12 t",
        audioAnswer: "correct.mp3"
      },
      {
        question: "Toutes les catégories d'usagers peuvent circuler dans la zone signalée par :",
        image: "../images/quizrue/rue8.jpg",
        options: [ 
          {text: "A. le panneau 1", isCorrect: true},
          {text: "B. le panneau 2", isCorrect: false}
        ],
        audioQuestion: "Toutes les catégories d'usagers peuvent circuler dans la zone signalée par :. A. le panneau 1, B. le panneau 2",
        audioAnswer: "correct.mp3"
      },
      {
        question: "Les panneaux bleus concernent la rue à ma gauche. En tournant à gauche, je vais circuler sur une rue",
        image: "../images/quizrue/rue9.jpg",
        options: [ 
          {text: "A. double sens", isCorrect: false},
          {text: "B. à sens unique", isCorrect: true}
        ],
        audioQuestion: "Les panneaux bleus concernent la rue à ma gauche. En tournant à gauche, je vais circuler sur une rue. A. double sens, B. à sens unique",
        audioAnswer: "correct.mp3"
      },
      {
        question: "Je risque de rencontrer : ",
        image: "../images/quizrue/rue9.jpg",
        options: [ 
          {text: "C. cyclistes ou des pietons", isCorrect: true},
          {text: "D. des véhicule", isCorrect: false}
        ],
        audioQuestion: "Je risque de rencontrer : C. cyclistes ou des pietons,D. des véhicule",
        audioAnswer: "correct.mp3"
      },
